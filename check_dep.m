...
% PDF doesn't give B matrix, so I'm assuming we're not supposed to clear
% variables

% Test 5
% A= [1 1 -3 -2.5; 2 5 -2 -1; -2 5 0 -1]
% The span of the columns of A includes all vectors in R3.
% b1 = -0.1739 a1 + 0.1304 a2 + -0.3478 a3 

% Test 6
% Error using check_dep (line 15)
% Number of rows in both matrices must equal.